"""
data was downloaded in usgs_pull.py and saved in gage_csvs
"""
import pandas as pd
import os
import xarray as xr
...
wd = os.getcwd()
basinsDir = r'data\streamflow\gage_csvs'

basinsWarea = gpd.read_file(r"data\model_watersheds.shp")
basinsWarea = basinsWarea.to_crs(epsg=3857)
basinsWarea = basinsWarea.sort_values(by='cdwr_id')
basinsWarea["area"] = basinsWarea['ws_area_sqkm'] * 1e6
...
signaturesDf['all_jan_Q_mmd'] = signaturesDf['all_jan_Q_mmd']*31
signaturesDf['all_feb_Q_mmd'] = signaturesDf['all_feb_Q_mmd']*28
signaturesDf['all_mar_Q_mmd'] = signaturesDf['all_mar_Q_mmd']*31
signaturesDf['all_apr_Q_mmd'] = signaturesDf['all_apr_Q_mmd']*30
signaturesDf['all_may_Q_mmd'] = signaturesDf['all_may_Q_mmd']*31
signaturesDf['all_jun_Q_mmd'] = signaturesDf['all_jun_Q_mmd']*30
signaturesDf['all_jul_Q_mmd'] = signaturesDf['all_jul_Q_mmd']*31
signaturesDf['all_aug_Q_mmd'] = signaturesDf['all_aug_Q_mmd']*31
signaturesDf['all_sep_Q_mmd'] = signaturesDf['all_sep_Q_mmd']*30
signaturesDf['all_oct_Q_mmd'] = signaturesDf['all_oct_Q_mmd']*31
signaturesDf['all_nov_Q_mmd'] = signaturesDf['all_nov_Q_mmd']*30
signaturesDf['all_dec_Q_mmd'] = signaturesDf['all_dec_Q_mmd']*31

# save it
outcsv = r"data\streamflow\hydro_signatures_wet_dry.csv"
...
outcsv = r"data\streamflow\hydro_signatures_wet_dry_wdeltas.csv"
